...
fn btree_cache_sweeps(c: &mut Criterion) {
    ...
    for &size in &[2_000usize, 20_000usize] {
        ...
        group.bench_with_input(BenchmarkId::new("insert/btree_safe_t4", size), &keys, |b, input| {
            b.iter(|| common::map_insert_bench::<common::BtSafeDeg4>(input));
        });
        group.bench_with_input(BenchmarkId::new("insert/btree_safe_t16", size), &keys, |b, input| {
            b.iter(|| common::map_insert_bench::<common::BtSafeDeg16>(input));
        });
        group.bench_with_input(BenchmarkId::new("insert/btree_safe_t64", size), &keys, |b, input| {
            b.iter(|| common::map_insert_bench::<common::BtSafeDeg64>(input));
        });

        group.bench_with_input(BenchmarkId::new("insert/btree_raw_t4", size), &keys, |b, input| {
            b.iter(|| common::map_insert_bench::<common::BtRawDeg4>(input));
        });
        group.bench_with_input(BenchmarkId::new("insert/btree_raw_t16", size), &keys, |b, input| {
            b.iter(|| common::map_insert_bench::<common::BtRawDeg16>(input));
        });
        group.bench_with_input(BenchmarkId::new("insert/btree_raw_t64", size), &keys, |b, input| {
            b.iter(|| common::map_insert_bench::<common::BtRawDeg64>(input));
        });

        group.bench_with_input(BenchmarkId::new("insert/btree_arena_t4", size), &keys, |b, input| {
            b.iter(|| common::map_insert_bench::<common::BtArenaDeg4>(input));
        });
        group.bench_with_input(BenchmarkId::new("insert/btree_arena_t16", size), &keys, |b, input| {
            b.iter(|| common::map_insert_bench::<common::BtArenaDeg16>(input));
        });
        group.bench_with_input(BenchmarkId::new("insert/btree_arena_t64", size), &keys, |b, input| {
            b.iter(|| common::map_insert_bench::<common::BtArenaDeg64>(input));
        });

        group.bench_with_input(
            BenchmarkId::new("contains_zipf/btree_safe_t4", size),
            &queries,
            |b, input| b.iter(|| common::map_contains_bench::<common::BtSafeDeg4>(&keys, input)),
        );
        group.bench_with_input(
            BenchmarkId::new("contains_zipf/btree_safe_t16", size),
            &queries,
            |b, input| b.iter(|| common::map_contains_bench::<common::BtSafeDeg16>(&keys, input)),
        );
        group.bench_with_input(
            BenchmarkId::new("contains_zipf/btree_safe_t64", size),
            &queries,
            |b, input| b.iter(|| common::map_contains_bench::<common::BtSafeDeg64>(&keys, input)),
        );
        group.bench_with_input(
            BenchmarkId::new("contains_zipf/btree_raw_t4", size),
            &queries,
            |b, input| b.iter(|| common::map_contains_bench::<common::BtRawDeg4>(&keys, input)),
        );
        group.bench_with_input(
            BenchmarkId::new("contains_zipf/btree_raw_t16", size),
            &queries,
            |b, input| b.iter(|| common::map_contains_bench::<common::BtRawDeg16>(&keys, input)),
        );
        group.bench_with_input(
            BenchmarkId::new("contains_zipf/btree_raw_t64", size),
            &queries,
            |b, input| b.iter(|| common::map_contains_bench::<common::BtRawDeg64>(&keys, input)),
        );
        group.bench_with_input(
            BenchmarkId::new("contains_zipf/btree_arena_t4", size),
            &queries,
            |b, input| b.iter(|| common::map_contains_bench::<common::BtArenaDeg4>(&keys, input)),
        );
        group.bench_with_input(
            BenchmarkId::new("contains_zipf/btree_arena_t16", size),
            &queries,
            |b, input| b.iter(|| common::map_contains_bench::<common::BtArenaDeg16>(&keys, input)),
        );
        group.bench_with_input(
            BenchmarkId::new("contains_zipf/btree_arena_t64", size),
            &queries,
