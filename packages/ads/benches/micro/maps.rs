...
pub fn bench_u64_maps(c: &mut Criterion) {
    ...
    for &size in &[1_000usize, 10_000usize] {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_bst_safe", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_bst_raw", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_bst_arena", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_avl_safe", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_avl_raw", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_avl_arena", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_rbt_safe", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_rbt_raw", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_rbt_arena", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_btree_safe_t8", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_btree_raw_t8", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_btree_arena_t8", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_splay_safe", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_splay_raw", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_splay_arena", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_skip_safe", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_skip_raw", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("insert/ads_skip_arena", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("contains/ads_splay_raw", size),
            &queries,
            |b, input| b.iter(|| common::map_contains_bench::<common::SplayRaw>(&keys, input)),
        );
        group.bench_with_input(
            BenchmarkId::new("contains/ads_splay_raw_adaptive", size),
            &queries,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("contains/ads_splay_arena", size),
            &queries,
            |b, input| b.iter(|| common::map_contains_bench::<common::SplayArena>(&keys, input)),
        );
        group.bench_with_input(
            BenchmarkId::new("contains/ads_splay_arena_adaptive", size),
            &queries,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_bst_safe", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_bst_raw", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_bst_arena", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_avl_safe", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_avl_raw", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_avl_arena", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_rbt_safe", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_rbt_raw", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_rbt_arena", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_btree_safe_t8", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_btree_raw_t8", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_btree_arena_t8", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_splay_safe", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_splay_raw", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_splay_arena", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_skip_safe", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_skip_raw", size),
            &keys,
            |b, input| {
        ...
        group.bench_with_input(
            BenchmarkId::new("remove/ads_skip_arena", size),
            &keys,
            |b, input| {
